...
class DevelopersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create developer" do
    assert_difference("Developer.count") do
      post developers_url, params: { developer: { first_name: @developer.first_name, last_name: @developer.last_name, uniqname: @developer.uniqname } }
    end
  ...
  test "should update developer" do
    patch developer_url(@developer), params: { developer: { first_name: @developer.first_name, last_name: @developer.last_name, uniqname: @developer.uniqname } }
