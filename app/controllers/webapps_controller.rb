class WebappsController < ApplicationController
  ...
  private
    ...
    def webapp_params
      params.require(:webapp).permit(:project_name, :language, :framework, :description, :notes, :status, :authentication, :database, :server_os, :server_location, :documentation, :git_repo, :app_url, :risk_manage_consideration, :start_date, :end_date)
    end
end
